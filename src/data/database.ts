...
export const INITIAL_APPOINTMENTS: Appointment[] = [
  ...
  },
  {
    ...
    status: 'ARRIVED',
    notes: 'متابعة واستشارة للاطمئنان على نتائج تحليل جرثومة المعدة',
...
export const INITIAL_VISITS: Visit[] = [
  {
    ...
    queueNumber: 1,
    receptionistData: {
      symptoms: 'سعال حاد وزكام',
      chronicDiseases: ['سكري من النوع الثاني', 'ارتفاع ضغط دم معتدل'],
      notes: 'كشف سابق بالعيادة',
    },
    clinicalData: {
      chiefComplaint: 'سعال حاد وزكام',
      history: 'دور برد موسمي مصحوب باحتقان شديد بالحلق',
      examination: 'احتقان بالزور والغشاء المخاطي',
      diagnosis: ['نزلة برد حادة وتأثر بالمجرى التنفسي العلوي ، التهاب الحلق واللوزتين'],
      treatment: 'تشرب سوائل كتير وراحة تامة',
    },
    vitalSigns: {
      ...
      height: 176,
      oxygenSaturation: 98,
      randomBloodSugar: 125,
    },
    startedAt: '2026-08-28T19:20:00Z',
    completedAt: '2026-08-28T19:49:00Z',
    createdAt: '2026-08-28T19:49:00Z',
...
export const INITIAL_PRESCRIPTIONS: Prescription[] = [
  {
    ...
    items: [
      {
        medicationId: 'med-prev-1',
        name: 'بانادول إكسترا (Panadol Extra)',
        strength: '500mg Paracetamol + 65mg Caffeine',
        form: 'أقراص (Tablets)',
        dose: 'قرصين عند اللزوم',
        frequency: 'كل 8 ساعات بعد الأكل',
        duration: '5 أيام',
        instructions: 'مسكن وخافض للحرارة',
      },
      {
        medicationId: 'med-prev-2',
        name: 'أوسباموكس 1جم (Ospamox)',
        strength: 'Amoxicillin 1g',
        form: 'أقراص (Tablets)',
        dose: 'قرص واحد',
        frequency: 'كل 12 ساعة بعد الأكل',
        duration: '7 أيام',
        instructions: 'مضاد حيوي لعلاج التهاب الحلق واللوزتين',
      },
      {
        medicationId: 'med-prev-3',
        name: 'كيتوفان 50 ملغ (Ketofan)',
        strength: 'Ketoprofen 50mg',
        form: 'كبسولات (Capsules)',
        dose: 'كبسولة واحدة',
        frequency: 'مرتين يومياً بعد الوجبات',
        duration: '5 أيام',
        instructions: 'مضاد للالتهاب ومسكن لآلام الحلق والجسم',
      },
    ],
    notes: 'تشرب سوائل كتير',
    createdAt: '2026-08-28T19:49:00Z',
    updatedAt: '2026-08-28T19:49:00Z',
  },
  {
