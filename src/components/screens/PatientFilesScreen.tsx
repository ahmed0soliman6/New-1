            ...
            <div className="bg-white dark:bg-[#111A2E] p-6 rounded-2xl border border-slate-200 dark:border-white/5 shadow-xs flex flex-col gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-[#bbc9ca] mt-1">
                      ...
                      <strong className="text-[#008f97] dark:text-[#00c2cb] font-mono">{selectedPatient.bloodGroup}</strong> • {selectedPatient.governorate}
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                <div className="p-3 bg-slate-50 dark:bg-[#080e1b] rounded-xl border border-slate-200 dark:border-white/5">
                  ...
                  <strong className="text-slate-900 dark:text-[#dde2f5] font-mono">{selectedPatient.registrationDate}</strong>
                </div>
                <div className="p-3 bg-slate-50 dark:bg-[#080e1b] rounded-xl border border-slate-200 dark:border-white/5">
                  <span className="text-slate-500 dark:text-[#859394] block text-[11px]">عدد الزيارات المثبتة:</span>
                  <strong className="text-[#008f97] dark:text-[#45dee7] font-mono">{selectedPatient.visitsCount} زيارات</strong>
                </div>
                <div className="p-3 bg-slate-50 dark:bg-[#080e1b] rounded-xl border border-slate-200 dark:border-white/5">
                  <span className="text-slate-500 dark:text-[#859394] block text-[11px]">إجمالي المدفوعات:</span>
                  <strong className="text-emerald-600 dark:text-[#10B981] font-mono">{selectedPatient.totalPaid} ج.م</strong>
                </div>
                <div className="p-3 bg-slate-50 dark:bg-[#080e1b] rounded-xl border border-slate-200 dark:border-white/5">
                  <span className="text-slate-500 dark:text-[#859394] block text-[11px]">آخر تشخيص إكلينيكي:</span>
                  <strong className="text-purple-700 dark:text-[#d0bcff] truncate block">{selectedPatient.lastDiagnosis}</strong>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-[#111A2E] p-6 rounded-2xl border border-slate-200 dark:border-white/5 shadow-xs">
              {activeTab === 'visits' && (
                <div className="space-y-4">
                  <h3 className="text-xs font-bold text-slate-900 dark:text-[#dde2f5] mb-2">تاريخ الزيارات بالعيادة</h3>
                  <div className="border-r-2 border-teal-300 dark:border-[#00c2cb]/40 pr-4 space-y-4">
                    <div className="relative">
                      ...
                      <div className="text-xs font-mono text-[#008f97] dark:text-[#00c2cb] font-bold">15 أكتوبر 2024 (اليوم)</div>
                    ...
                    <div className="relative">
                      <span className="w-2.5 h-2.5 rounded-full bg-slate-300 dark:bg-slate-600 absolute -right-[21px] top-1.5"></span>
                      <div className="text-xs font-mono text-slate-400 dark:text-[#859394]">02 أغسطس 2024</div>
                      <div className="font-bold text-sm text-slate-900 dark:text-[#dde2f5] mt-0.5">
              ...
              {activeTab === 'labs' && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <h3 className="text-xs font-bold text-slate-900 dark:text-[#dde2f5]">تقارير التحاليل والأشعة المرفقة</h3>
                    <span className="text-[11px] text-[#008f97] dark:text-[#00c2cb] font-semibold cursor-pointer hover:underline">
                      + رفع تقرير معملي
                    </span>
                  </div>

                  <div className="p-3 rounded-xl bg-slate-50 dark:bg-[#080e1b] border border-slate-200 dark:border-white/5 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <span className="material-symbols-outlined text-2xl text-[#008f97] dark:text-[#00c2cb]">biotech</span>
                      <div>
                        <div className="text-xs font-bold text-slate-900 dark:text-[#dde2f5]">تحليل إنزيمات قلب عاجلة (Troponin I & CK-MB)</div>
                        <div className="text-[10px] text-slate-400 dark:text-[#859394]">معمل البرج - المهندسين • 15 أكتوبر 2024</div>
                      </div>
                    </div>
                    <span className="px-2.5 py-1 rounded bg-emerald-50 dark:bg-[#10B981]/20 text-emerald-700 dark:text-[#10B981] text-xs font-bold">
                      طبيعي Negative
                    </span>
                  </div>
                  ...
                  <div className="p-3 rounded-xl bg-slate-50 dark:bg-[#080e1b] border border-slate-200 dark:border-white/5 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-xs font-bold text-slate-900 dark:text-[#dde2f5]">رسم قلب كهربائي 12-Lead ECG</div>
                        <div className="text-[10px] text-slate-400 dark:text-[#859394]">عيادة سولي • 15 أكتوبر 2024</div>
                      </div>
                    </div>
                    <span className="px-2.5 py-1 rounded bg-emerald-50 dark:bg-[#10B981]/20 text-emerald-700 dark:text-[#10B981] text-xs font-bold">
                      Normal Sinus Rhythm
              ...
              {activeTab === 'billing' && (
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="p-3 bg-slate-50 dark:bg-[#080e1b] rounded-xl border border-slate-200 dark:border-white/5 flex items-center justify-between text-xs">
                      <div>
                        <span className="font-bold text-slate-900 dark:text-[#dde2f5]">كشف باطنة وقائي (العيادة)</span>
                        <span className="text-[11px] text-slate-400 dark:text-[#859394] block font-mono">15/10/2024 • إيصال #REC-8192</span>
                      </div>
                      <div className="text-left">
                        <span className="font-mono font-bold text-[#008f97] dark:text-[#45dee7]">300 ج.م</span>
                        <span className="text-[10px] text-emerald-600 dark:text-[#10B981] block">مسدد نقداً ✓</span>
                      </div>
                    </div>
                  </div>
                </div>
